...
export const levelContent: Readonly<Record<string, LevelContent>> = {
  '01': {
    ...
    teaching: 'Watch the delay, then move the robot away from the crossing.',
  ...
  '02': {
    ...
    teaching: 'A beat is one step of harbor time. Tap the robot to choose when it starts.',
  ...
  '03': {
    ...
    teaching: 'The bridge is raised through beat 3. Tap the bus to compare its routes.',
  ...
  '04': {
    ...
    teaching: 'The bus starts after the parcel arrives. Tap the robot to inspect the handoff routes.',
  ...
  '05': {
    ...
    teaching: 'Queues can form beyond the crossing. Inspect the robot route before pressing Go.',
  ...
  '06': {
    ...
    teaching: 'You have two changes. Tap the robot and cart to clear a lane for the bus.',
  ...
  '07': {
    ...
    teaching: 'Go checks one plan in both possible days. Use the future buttons to inspect each result.',
  ...
  '08': {
    ...
    teaching: 'Choose one robot start beat. Go will test it against both bus schedules.',
  ...
  '09': {
    ...
    teaching: 'The upper lane closes in one future. Choose one route that works in all three.',
  ...
  '10': {
    ...
    teaching: 'Use two changes for the robot and cart. Go checks all three futures together.',
