...
| Browser suite | `npx playwright test --project=chromium` | 12 stories passed in 46.0 seconds |
...
Firefox and WebKit binaries could not be downloaded after repeated 120-second attempts across Playwright mirrors. Physical iOS and Android hardware, screen readers, real touch interruption, safe areas, installed-app lifecycle, hosting headers, and storefront submission are outside current access.
